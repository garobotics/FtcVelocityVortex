...
@Autonomous(name="baseStateMachine RED")

public class baseStateMachine extends HardwareClass {
    baseState state;    // declares variable state of type State
        ...
        switch(state) {
            case INITIALIZE:
                ...
                if ((Math.abs(motorRightFront.getCurrentPosition()) < 5) && (Math.abs(motorLeftFront.getCurrentPosition()) < 5)) {
                    ...
                    changeState(baseState.LAUNCH_BALL);
                }
                else {
            ...
            case LAUNCH_BALL:
                ...
                if (ballFlipper.getCurrentPosition() >= 1120) {
                    ...
                    motorRightFront.setTargetPosition(-1900);
                    motorLeftFront.setTargetPosition(-1900);
                    /*//crab right
                    ...
                    //motorLeftFront.setPower(.5);
                    //motorLeftRear.setPower(.5);
                    changeState(baseState.MOVE_TO_BEACON);
                }
                else {
            ...
            case MOVE_TO_BEACON:
                ...
                if ((motorRightFront.getCurrentPosition() <= -1900) || (motorLeftFront.getCurrentPosition() <= -1900)) {
                    ...
                    motorRightRear.setPower(.5);
                    motorLeftRear.setPower(.5);
                    changeState(baseState.DRIVE_TO_RAMP);
                }
                else {
